...
```bash
ansible-playbook -i centos-07-servers_inventory.yml ~/ANSIBLE/provision_hosts_el7/Foreman_provision_hosts_el7.yml -e "target_hosts=cent-07-02 foreman_server=1 hostgroup=1"
```

### RAID Installation

```bash
ansible-playbook -i centos-07-servers_inventory.yml ~/ANSIBLE/provision_hosts_el7/Foreman_provision_hosts_el7.yml -e "target_hosts=cent-07-02 foreman_server=1 hostgroup=2"
```
...
```bash
ansible-playbook -i centos-07-servers_inventory.yml ~/ANSIBLE/provision_hosts_el7/Foreman_provision_hosts_el7.yml -e "target_hosts=cent-07-02,cent-07-03 foreman_server=1 hostgroup=1"
```
...
```bash
ansible-playbook -i centos-07-servers_inventory.yml ~/ANSIBLE/provision_hosts_el7/Foreman_provision_hosts_el7.yml -e "target_hosts=HOSTNAME foreman_server=1 hostgroup=1"
```

### RAID

```bash
ansible-playbook -i centos-07-servers_inventory.yml ~/ANSIBLE/provision_hosts_el7/Foreman_provision_hosts_el7.yml -e "target_hosts=HOSTNAME foreman_server=1 hostgroup=2"
```
