...
```bash
ansible-playbook ~/ANSIBLE/provision_hosts_el9/Foreman_provision_hosts_el9.yml -e "target_hosts=rocky-09-01 foreman_server=1 hostgroup=1"
```

### RAID Installation

```bash
ansible-playbook ~/ANSIBLE/provision_hosts_el9/Foreman_provision_hosts_el9.yml -e "target_hosts=rocky-09-01 foreman_server=1 hostgroup=2"
```
...
```bash
ansible-playbook ~/ANSIBLE/provision_hosts_el9/Foreman_provision_hosts_el9.yml -e "target_hosts=rocky-09-01,rocky-09-02 foreman_server=1 hostgroup=1"
```
...
```bash
ansible-playbook ~/ANSIBLE/provision_hosts_el9/Foreman_provision_hosts_el9.yml -e "target_hosts=HOSTNAME foreman_server=1 hostgroup=1"
```

### RAID

```bash
ansible-playbook ~/ANSIBLE/provision_hosts_el9/Foreman_provision_hosts_el9.yml -e "target_hosts=HOSTNAME foreman_server=1 hostgroup=2"
```
