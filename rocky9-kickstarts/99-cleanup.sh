...
################################################################################
# Rebuild GRUB Configuration (Rocky 9 Modern Path Realignment Enforced)
################################################################################
echo "Updating GRUB configuration..."
# Fixed: Rocky 9 writes and evaluates the core grub parameters inside /boot/grub2/
grub2-mkconfig -o /boot/grub2/grub.cfg

# Maintain fallback backwards compatibility check safely
